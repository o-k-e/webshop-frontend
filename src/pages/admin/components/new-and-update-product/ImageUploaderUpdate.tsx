	...
	return (
		<div className="space-y-2">
			...
			<div
				...
				className="w-full border-2 border-dashed border-gray-300 bg-white p-6 rounded-xl text-center cursor-pointer hover:bg-[#fafafacc] focus:outline-none focus:ring-2 hover:border-[#953733cc] transition"
			>
